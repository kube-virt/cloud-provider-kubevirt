...
require (
	...
	github.com/kube-virt/loadbalancer-api v0.0.0
...
replace github.com/kube-virt/loadbalancer-api v0.0.0 => /home/suman/go/src/github.com/kube-virt/loadbalancer-api
